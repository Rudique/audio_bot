...
def get_model():
    ...
    if _model is None:
        ...
        # Используем модель "base" - лучший баланс между скоростью и качеством
        # Для более быстрой работы можно использовать "tiny"
        # Для максимального качества можно использовать "small" или "medium"
        _model = WhisperModel(
            "base",
            device="cpu",
            compute_type="int8",
